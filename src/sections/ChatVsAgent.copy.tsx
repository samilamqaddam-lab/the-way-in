...
export const CHAT_VS_AGENT_COPY = {
  ...
  fr: {
    ...
    kicker: 'Le même message, deux matinées très différentes. Regarde — et quand l’agent te pose la question, réponds.',
...
export const THEATER_COPY = {
  ...
  fr: {
    ...
    receipt: [
      '1. Installe un éditeur de code',
      '2. Nouveau fichier : index.html',
      '3. Copie ce HTML dedans',
      '4. Nouveau fichier : style.css',
      '5. Relie la feuille de style',
      '6. Enregistre tout',
      '7. Ouvre-le dans un navigateur',
      '8. Corrige ce qui cloche',
      '9. Ajoute des confettis en JS',
    ],
